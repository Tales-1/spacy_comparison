...
# NOTE My comments on the difference between using the sm and md models
# When using the sm model for comparing similarity the console lets us know that the sm model has no word vectors loaded
# This means the Doc.similarity method is based on the tagger, parser and NER which isn't as accurate for similarity judgments.
# When looking at the values I noticed that when the sm model is used, the similarity values are significantly lower than
# the values provided when using the md model. For example the complaints similarity values in the md model are:
#1.0
# 0.835077095517691
# 0.9246800668484182
# 0.8959758607031337
...
# 0.8622109066850939
# 0.835077095517691
# Where as in the sm model the similarity values are:
#1.0
# 0.5090130466174222
# 0.7128344854285678
# 0.7586548283376252
